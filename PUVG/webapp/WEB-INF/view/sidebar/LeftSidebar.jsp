...
<div class="menu">
	<div class="menu_img">
		<a href="memberChart.puvg"><img src="/PUVG/css/icons/logo.png" class="menuImg"/></a>
	</div>
	<div class="menuCategory">
		...
		<div class="menuSmall4">
			<a href="scheduleMain.puvg?vnum=V202207100001&checkstatus=123" class="menuA">- 일정 달력</a><br>
			<a href="scheduleBoardSelectAll.puvg?vnum=test&checkstatus=123" class="menuA">- 일정 게시판</a><br>
		</div>
