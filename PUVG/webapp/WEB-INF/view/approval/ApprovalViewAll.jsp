...
<div class="boardSallDiv1">
	...
	<div class="boardSallDiv2">
		<input type="button" id="selectAllBtn" class="boardSallbtn"  value="문서함" onclick= "location.href = 'ApprovalTempSelectAll.puvg'">
	</div>
	</div>
		...
		<table class="boardSallTable">
			...
			<tr>
				<td class="boardSallTd3_2">
					<a href="ApprovalAcceptSelect.puvg?vdocnum=<%= avo.getVdocnum()%>"><%= avo.getVsubj()%></a>
				</td>
