...
public class ApprovalDAOImpl implements ApprovalDAO {
	...
	@Override
	public List<Appr1DocVO> ApprovalViewAll(Appr1DocVO amvo) {
		logger.info("ApprovalDAOImpl ApprovalViewAll() 함수 진입");
		
		return sqlSession.selectOne("ApprovalViewAll", amvo);
	}
	
	public List<Appr1DocVO> ApprovalViewSelect(Appr1DocVO amvo) {
		logger.info("ApprovalDAOImpl ApprovalViewSelect() 함수 진입");
		
		return sqlSession.selectOne("ApprovalViewSelect", amvo);
	}
