...
public class ApprovalServiceImpl implements ApprovalService {
	...
	public List<Appr1DocVO> ApprovalViewAll(Appr1DocVO amvo) {
		...
		logger.info("ApprovalServiceImpl ApprovalViewAll() 함수 진입");
		return approvalDAO.ApprovalViewAll(amvo);
	}

	@Override
	public List<Appr1DocVO> ApprovalViewSelect(Appr1DocVO amvo) {
		// TODO Auto-generated method stub
		logger.info("ApprovalServiceImpl ApprovalViewSelect() 함수 진입");
		return approvalDAO.ApprovalViewSelect(amvo);
	}
